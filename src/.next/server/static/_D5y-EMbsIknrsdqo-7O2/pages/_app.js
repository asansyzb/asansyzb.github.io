...
/******/ 			var chunk = require("../../..//" + ({}[chunkId]||chunkId) + "." + {"6":"ff4edd618699c87d6949"}[chunkId] + ".js");
...
/* harmony import */ var _material_ui_styles_ThemeProvider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("ZBA7");
...
/* harmony import */ var styles_theme__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("iaY6");
...
const Layout = next_dynamic__WEBPACK_IMPORTED_MODULE_5___default()(() => __webpack_require__.e(/* import() */ 6).then(__webpack_require__.bind(null, "apO0")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("apO0")],
    modules: ["components/Layout"]
  }
});

class AppWrapper extends next_app__WEBPACK_IMPORTED_MODULE_0___default.a {
  ...
  render() {
    ...
    return __jsx(_material_ui_styles_ThemeProvider__WEBPACK_IMPORTED_MODULE_2___default.a, {
      theme: styles_theme__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"]
    }, __jsx(_material_ui_core_CssBaseline__WEBPACK_IMPORTED_MODULE_3___default.a, null), __jsx(Layout, null, __jsx(Component, pageProps)));
  }
